...
\index{TPChartSolidFill-p@{TPChartSolidFill-p}!fillColors@{fillColors}}
\index{fillColors@{fillColors}!TPChartSolidFill-p@{TPChartSolidFill-p}}
...
Get the chart fill color \begin{Desc}
